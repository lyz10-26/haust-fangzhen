                        ...
                        <div>
                            ...
                            <div class="replycontainer layui-hide" style="margin-left: 61px;">
                                <form action="<%=basePath%>/article/saveReply.do" method="post" class="layui-form">
                                    <input name="lr_for_article_id" value="${article.r_id}" hidden="hidden"/>
                                    <input name="lr_name"  value="${sessionScope.name}" hidden="hidden"/>
                                    <input name="lr_date" value="<%=nowDate%>" hidden="hidden"/>
                                    <input name="lr_for_name"  value="${words.lw_name}" hidden="hidden"/>
                                    <input name="lr_for_words"  value="${words.lw_id}" hidden="hidden"/>
                                    <input name="lr_for_reply"  value="${reply.lr_id}" hidden="hidden"/>
                                    <div class="layui-form-item">
                                        <textarea name="lr_content"  lay-verify="replyContent" placeholder="请输入回复内容" class="layui-textarea" style="min-height:80px;"></textarea>
                                    </div>
                                    <div class="layui-form-item">
