...
<div class="container">
    <div id="content">
        <h2 class="text-nowrap" style="color: #393D49;text-align:center;padding-top:20px;font-family: Menlo">虚拟仿真实验教学系统登录</h2>
        ...
        <form action="<%=basePath%>/admin/login.do" id="loginform" method="post" class="layui-form" style="text-align: center;margin-right:58px;margin-top:40px;">
            ...
            <div>
                ...
                <div style="text-align:center;color: #009688;background-color: #01AAED;width:48%;margin-left:138px;">
                    <input type="submit" class="layui-btn layui-btn-lg" style="background: none;" value="提交"/>
                     </div>
            </div>
        </form>
